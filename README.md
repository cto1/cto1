...
📍 Jávea, Spain ↔ London | 🚀 Serial Builder | 📖 Author | Ex-Meta | 🏗️ Consultant CTO 
...
![AI](https://img.shields.io/badge/-AI%20%2F%20LLMs-412991?style=flat&logo=openai&logoColor=white)
...
- 🔍 **Search projects**
- 📖 **CTO Book** – Contrarian tech leadership insights. Short (4 books), expanded (1book) opinionated takes on how to actually run technology.
...
- 🗺️ **[travel-time-finder](https://github.com/cto1/travel-time-finder-for-multiple-addresses)** – Bulk address travel distance/duration discovery using the Google Maps Distance API.
- 📝 **[notes-mgmt-cli](https://github.com/cto1/notes-mgmt-command-line-app)** – Simple command-line note management app.
- 🧺 **[wash-app](https://github.com/cto1/wash-app)** – Full-stack Express + MongoDB app with Stripe payments for location-based services.
- 🎓 **[Gradefully](https://github.com/cto1/Gradefully)** – Supporting parents and students during exams.
